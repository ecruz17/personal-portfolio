...
export const Footer = () => {
  return (
    <footer className='mt-auto shadow-md bg-blueBackground text-center py-4' id='footer'>
      <h2 className='text-2xl md:text-4xl font-bold'>CONTACT ME</h2>
      <div className='flex flex-col justify-center items-center'>
        <div className='flex w-full justify-center items-center my-3 gap-14 md:gap-32'>
          <Link target="_blank" href="https://www.linkedin.com/in/ecruzdev/" rel="noopener noreferrer">
            <BsLinkedin className='w-6 h-6 md:w-12 md:h-12'/>
          </Link>
          <Link target="_blank" href="https://github.com/ecruz17" rel="noopener noreferrer">
            <BiLogoGithub className='w-6 h-6 md:w-12 md:h-12'/>
          </Link>
          <Link target="_blank" href="mailto:emircruz.m@gmail.com" rel="noopener noreferrer">
